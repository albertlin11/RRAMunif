...
# training data
df = pd.read_csv(r'.\input data\IV_RRAM_TriD_35_1_real_new_cont.csv')
...
# testing data
df1 = pd.read_csv(r'.\input data\IV_RRAM_TriD_35_1_real_new_cont.csv')
...
# filepath= r'.\csv\continuous\train_TriD_real_new.csv'
...
# filepath1= r'.\csv\continuous\test_TriD_real_new.csv'
