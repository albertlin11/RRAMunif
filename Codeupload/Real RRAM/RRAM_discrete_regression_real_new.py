...
# training data
df = pd.read_csv(r'.\input data\IV_RRAM_TriD_35_1_real_new.csv')
...
# testing data
df1 = pd.read_csv(r'.\input data\IV_RRAM_TriD_35_1_real_new.csv')
...
w_next = tf.keras.layers.Dense(units = 1,name='output_w')(w_next)
...
hist = model.fit(x=[v_train,w_train_0], y=[w_train, y_train],batch_size = 32,epochs=100000,shuffle=True,verbose=1,callbacks=[callback])
model.summary()
...
# filepath= r'.\csv\discrete\regression\train_TriD_real_new.csv'
...
# filepath1= r'.\csv\discrete\regression\test_TriD_real_new.csv'
